...
#  Default: False
c.JupyterQtConsoleApp.maximize = True
...
c.HistoryConsoleWidget.font_size = 7
...
c.HistoryConsoleWidget.kind = 'rich'
...
#  Default: True
c.FrontendWidget.confirm_restart = False
...
#c.IPythonWidget.confirm_restart = False
...
## The visibility of the scrollar. If False then the scrollbar will be
#  See also: ConsoleWidget.scrollbar_visibility
#c.IPythonWidget.scrollbar_visibility = False
...
## Whether to ask for user confirmation when restarting kernel
#  See also: FrontendWidget.confirm_restart
c.JupyterWidget.confirm_restart = False
...
#  Default: ''
c.JupyterWidget.editor = 'terminator -x /usr/local/bin/nvim'
...
## The visibility of the scrollar. If False then the scrollbar will be
#  See also: ConsoleWidget.scrollbar_visibility
c.JupyterWidget.scrollbar_visibility = False
