...
#c.InteractiveShell.banner1 = "Python 3.8.5 | packaged by conda-forge | (default, Aug 29 2020, 01:22:49) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.18.1 -- An enhanced Interactive Python. Type '?' for help.\n"
...
c.TerminalInteractiveShell.editor = 'terminator -x /usr/local/bin/nvim.appimage'
...
c.InteractiveShellApp.exec_lines = [
        ...
        #"import vaex",
        #"from sympy import *",
        #"init_printing(num_columns=260)",
        #"cd Códigos/G-Research\ Crypto\ Forecasting/",
        ]
